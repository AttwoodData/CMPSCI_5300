...
The two algorithms are Hill Climbing and Simulated Annealing and will
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{simulated\PYZus{}annealing}\PY{p}{(}\PY{n}{temp\PYZus{}decay}\PY{p}{,} \PY{n}{print\PYZus{}output}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{if} \PY{n}{print\PYZus{}output}\PY{p}{:}
    ...
    \PY{k}{return} \PY{n}{error\PYZus{}old}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{e\PYZus{}o} \PY{o}{=} \PY{n}{simulated\PYZus{}annealing}\PY{p}{(}\PY{l+m+mf}{0.01}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
Final Error: 1.04
Final Weights: [-5 38 -1]
    \end{Verbatim}
    ...
    Average objective function value from 100 trials:

    \begin{tcolorbox}[breakable, size=fbox, boxrule=1pt, pad at break*=1mm,colback=cellbackground, colframe=cellborder]
\prompt{In}{incolor}{11}{\boxspacing}
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{simulated\PYZus{}annealing}\PY{p}{(}\PY{l+m+mf}{0.01}\PY{p}{,} \PY{k+kc}{False}\PY{p}{)} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{100}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{e\PYZus{}o} \PY{o}{=} \PY{n}{simulated\PYZus{}annealing}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
Final Error: 0.02
Final Weights: [23 24 -4]
    \end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{simulated\PYZus{}annealing}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{k+kc}{False}\PY{p}{)} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{100}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{e\PYZus{}o} \PY{o}{=} \PY{n}{simulated\PYZus{}annealing}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}

    \begin{Verbatim}[commandchars=\\\{\}]
Final Error: 0.00
Final Weights: [18 18 -8]
    \end{Verbatim}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{sum}\PY{p}{(}\PY{p}{[}\PY{n}{simulated\PYZus{}annealing}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{k+kc}{False}\PY{p}{)} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{100}\PY{p}{)}\PY{p}{]}\PY{p}{)}\PY{o}{/}\PY{l+m+mi}{100}
\end{Verbatim}
\end{tcolorbox}
...
couple hours -- and finally found the bug after an initial submission.
There was an extra indent of the update preventing it from occurring at
the correct step.
